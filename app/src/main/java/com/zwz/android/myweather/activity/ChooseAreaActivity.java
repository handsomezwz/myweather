package com.zwz.android.myweather.activity;
...
import com.zwz.android.myweather.R;
...
import com.zwz.android.myweather.util.HttpCallbackListener;
import com.zwz.android.myweather.util.HttpUtil;
import com.zwz.android.myweather.util.Utility;
...
public class ChooseAreaActivity extends Activity {
    ...
    /**
     * 查询全国所有的省，优先从数据库查询，如果没有查询到去服务器上查询
     * */
    ...
    private void queryCounties(){
        countyList = myWeatherDB.loadCountries(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)){
                    ...
                    result = Utility.handCountyResponse(myWeatherDB,
    ...
    /**
     * 捕获Back按键，根据当前的级别来判断，此时应该返回是列表，省列表，还是直接退出
     * */
    @Override
